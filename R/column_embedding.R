...
ColEmbedding <- nn_module(
  ...
  # TODO improve readability with a straight case_when() on all bianry variables
  # TODO question isn't it managed by hardhat triple dispatch upfront ?
